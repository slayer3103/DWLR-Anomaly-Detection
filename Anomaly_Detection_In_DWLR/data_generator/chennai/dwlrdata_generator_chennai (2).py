...
# Parameters
num_rows = 15
initial_depth = 12.0  # Starting depth for Chennai
max_depth_summer = 50.0  # Maximum depth during dry season
min_depth_monsoon = 5.0  # Depth limit during peak monsoon recharge
temp_min = 26.0  # Minimum groundwater temperature for Chennai's climate
temp_max = 32.0  # Maximum groundwater temperature during summer
...
city = "chennai"  # Adjust this value to generate data for a specific city 
dwlr_id = city_dwlr_ids[city]

# Month ranges for groundwater depth
seasonal_ranges = {
    'Jan': (25, 35),   # Mild dry
    'Feb': (27, 37),   # Pre-summer dry
    'Mar': (30, 40),   # Summer onset
    'Apr': (35, 45),   # Early summer
    'May': (40, 50),   # Peak summer
    'Jun': (38, 48),   # Late summer
    'Jul': (30, 45),   # Pre-monsoon buffer
    'Aug': (20, 35),   # Monsoon recharge
    'Sep': (10, 25),   # Peak monsoon
    'Oct': (5, 15),    # Post-monsoon
    'Nov': (10, 20),   # Early winter
    'Dec': (15, 25),   # Winter
}

# Initialize data lists
data = []
current_date = datetime(2034, 1, 1)
depth = initial_depth
...
# Save to CSV
df.to_csv('dwlrdata_chennai(2).csv', index=False)
print("Data generation complete. Saved as 'dwlrdata_chennai.csv'.")
